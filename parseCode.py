...
CONFIGS = { "Fire" : { "enable-divisions": False,
            ...
            "HOUSING": { "enable-divisions": False,
                         "enable-subsections": True,
                         "section-re": 0 },
            "Admin_S": { "enable-articles": False,
                         "enable-subsections": True,
                         "exclude-appendices": True },
...
class CodeParser:
    ...
    def __init__( self, config = None ):
        ...
        self.enableArticles = True
        self.enableBareSections = False
        self.excludeAppendices = False
    ...
    def updateConfig( self, config ):
        ...
        if config:
            ...
            if "enable-articles" in config:
                self.enableArticles = config["enable-articles"]
            if "exclude-appendices" in config:
                self.excludeAppendices = config["exclude-appendices"]
    ...
    def parseLine( self ):
        ...
        print "line: ", line
        if self.excludeAppendices and ( re.match( ur'^APPENDICES:\s*$', line ) ):
        ...
        if m:
            ...
            if ( ( codeName not in [ 'MUNICIPAL', 'FORMER', 'SEE SAN FRANCISCO MUNICIPAL' ] ) and 
